...
<!--
Phase 7 落盘。
默认填"摘要"1-2 句话即可,用户喊 `retro` 才走完整 6 题。
无论哪种,本任务踩坑要点必须追加到 _lessons.md。
-->
...
- 工时 vs 预估:☐ 符合 / ☐ 低估 <50% / ☐ 低估 ≥50% / ☐ 高估 — 说明:
- 澄清是否充分:☐ 充分 / ☐ 有遗漏可补救 / ☐ 严重不足 — 说明:
- 方案回看:☐ 还选 A / ☐ 改选 B / ☐ 重新设计 — 说明:
- 需要改全局规则:☐ 不需要 / ☐ 需要 — 建议:
- 踩了什么坑(具体到代码 / 文档 / 流程):
- 下次怎么避免(操作层面,可执行):
